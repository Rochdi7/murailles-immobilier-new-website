...
function murailles_t( $default, $echo = true ) {
	// Avoid registering strings on every frontend render. The theme already
	// seeds its base dictionary on init via inc/i18n-strings.php; this admin-only
	// fallback keeps late-added strings discoverable without polluting runtime.
