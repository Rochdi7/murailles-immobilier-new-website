		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data" style="background:#fff;padding:24px;border:1px solid #c3c4c7;border-top:none;">
			...
			<div style="margin:24px 0 12px;padding:16px;border:1px solid #dcdcde;border-radius:8px;background:#fff;">
				...
				<div id="murailles-testi-repeater-<?php echo esc_attr( $lang_code ); ?>" class="murailles-testi-repeater" data-lang="<?php echo esc_attr( $lang_code ); ?>">
					...
					<div class="murailles-repeater-row" style="background:#f9f9f9;border:1px solid #e0e0e0;padding:16px;margin-bottom:12px;border-radius:6px;">
						<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;">
							<?php murailles_theme_options_render_testimonial_photo_field( 'testimonials_' . $lang_code . '[' . $i . ']', $t ); ?>
							<div>
								<label>Nom</label><br>
							...
							<div>
								...
								<input type="text" inputmode="decimal" name="testimonials_<?php echo esc_attr( $lang_code ); ?>[<?php echo $i; ?>][rating]" value="<?php echo esc_attr( $t['rating'] ?? 5 ); ?>" class="small-text">
							</div>
			...
			<div id="murailles-testi-repeater">
				...
				<div class="murailles-repeater-row" style="background:#f9f9f9;border:1px solid #e0e0e0;padding:16px;margin-bottom:12px;border-radius:6px;">
					<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;">
						...
						<div>
							<label>Note (ex: 4.8)</label><br>
							<input type="text" inputmode="decimal" name="testimonials[<?php echo $i; ?>][rating]" value="<?php echo esc_attr( $t['rating'] ?? 5 ); ?>" class="small-text">
						</div>
						<div style="grid-column:span 2;">
