<?php
/**
 * Template Name: Classical Layout With Map
 *
 * Auto-converted from classical-layout-with-map.html
							...
							<div class="page-sidebar p-0">
								...
								<div class="collapse" id="fltbox">
									...
									<div class="sidebar-widgets p-4">
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 pt-4">
												<button class="btn btn-danger rounded full-width">Find New Home</button>
											</div>
										</div>
						...
						<div class="col-lg-8 col-md-12 col-sm-12">
							<div class="row justify-content-center g-4">
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div class="property-listing list_view shadow-0">
											...
											<div class="listing-detail-wrapper mt-1">
												<div class="listing-short-detail-wrap">
													<div class="_card_list_flex mb-2">
														...
														<div class="_card_flex_last">
															<h6 class="listing-card-info-price text-danger mb-0">$10,500</h6>
														</div>
													</div>
													<div class="_card_list_flex">
														<div class="_card_flex_01">
											...
											<div class="listing-detail-wrapper mt-1">
												<div class="listing-short-detail-wrap">
													<div class="_card_list_flex mb-2">
														...
														<div class="_card_flex_last">
															<h6 class="listing-card-info-price text-danger mb-0">$8,700</h6>
														</div>
													</div>
													<div class="_card_list_flex">
														<div class="_card_flex_01">
											...
											<div class="listing-detail-wrapper mt-1">
												<div class="listing-short-detail-wrap">
													<div class="_card_list_flex mb-2">
														...
														<div class="_card_flex_last">
															<h6 class="listing-card-info-price text-danger mb-0">$9,100</h6>
														</div>
													</div>
													<div class="_card_list_flex">
														<div class="_card_flex_01">
											...
											<div class="listing-detail-wrapper mt-1">
												<div class="listing-short-detail-wrap">
													<div class="_card_list_flex mb-2">
														...
														<div class="_card_flex_last">
															<h6 class="listing-card-info-price text-danger mb-0">$7,400</h6>
														</div>
													</div>
													<div class="_card_list_flex">
														<div class="_card_flex_01">
									...
									<div class="property-listing list_view shadow-0">
										...
										<div class="list_view_flex">
											...
											<div class="listing-detail-wrapper mt-1">
												<div class="listing-short-detail-wrap">
													<div class="_card_list_flex mb-2">
														...
														<div class="_card_flex_last">
															<h6 class="listing-card-info-price text-danger mb-0">$9,700</h6>
														</div>
													</div>
													<div class="_card_list_flex">
														<div class="_card_flex_01">
											...
											<div class="listing-detail-footer">
												...
												<div class="footer-flex">
													<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-seegreen bg-seegreen">View Detail</a>
												</div>
											</div>
										</div>
