										...
										<div class="listing-img-wrapper">
											...
											<div class="list-img-slide">
												<div class="click">
													...
													<div><a href="<?php echo esc_url( $link ); ?>"><img src="<?php echo esc_url( $img_url ); ?>" class="img-fluid mx-auto" alt="<?php the_title_attribute(); ?>" /></a></div>
													<?php endforeach; ?>
												</div>
											</div>
										</div>
												...
												<ul class="selio_style">
													<li>
														<div class="prt_saveed_12lk">
															<label class="toggler toggler-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo esc_attr( murailles_t( 'Sauvegarder', false ) ); ?>"><input type="checkbox"><i class="fa-solid fa-heart"></i></label>
														</div>
													</li>
													<li>
														<div class="prt_saveed_12lk">
															<a href="<?php echo esc_url( home_url( '/compare-property/' ) ); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo esc_attr( murailles_t( 'Comparer', false ) ); ?>"><i class="fa-solid fa-share"></i></a>
														</div>
													</li>
													<li>
														<div class="prt_saveed_12lk">
															<a href="<?php echo esc_url( $link ); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo esc_attr( murailles_t( 'Voir le bien', false ) ); ?>"><i class="fa-regular fa-circle-right"></i></a>
														</div>
													</li>
												</ul>
											</div>
