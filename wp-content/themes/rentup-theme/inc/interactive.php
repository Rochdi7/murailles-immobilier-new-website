...
// Auxiliary page creation is manual-only. The theme must not create or repair
// pages automatically during wp-admin loads or file-only theme updates.
...
add_action('admin_init', function () {
	return; // Disabled: page repair is manual-only.
