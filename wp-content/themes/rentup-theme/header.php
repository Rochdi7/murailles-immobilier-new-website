			...
			<div class="container">
				<nav id="navigation" class="navigation navigation-landscape">
					<div class="nav-header">
						<a class="nav-brand static-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'logo-light.png' ) ); ?>" class="logo" alt="<?php bloginfo( 'name' ); ?>" /></a>
						<a class="nav-brand fixed-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'logo.png' ) ); ?>" class="logo" alt="<?php bloginfo( 'name' ); ?>" /></a>
					...
					<div class="nav-menus-wrapper" style="transition-property: none;">
						<a class="nav-brand mobile-menu-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
							<img src="<?php echo esc_url( murailles_img( 'logo.png' ) ); ?>" alt="<?php bloginfo( 'name' ); ?>" />
						</a>
				...
				<nav id="navigation" class="navigation navigation-landscape">
					<div class="nav-header">
						<a class="nav-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>">
							<img src="<?php echo esc_url( murailles_img( 'logo.png' ) ); ?>" class="logo" alt="<?php bloginfo( 'name' ); ?>" />
						</a>
						<div class="nav-toggle"></div>
						<div class="mobile_nav">
							<ul class="nav-menu nav-menu-social mobile-lang-switcher">
