...
<!-- ============================ Page Title ================================== -->
<div class="page-title histoire-hero" style="background:linear-gradient(135deg,rgba(220,53,69,0.85),rgba(26,35,50,0.85)),url(<?php echo esc_url( murailles_img( 'banner-home.jpg' ) ); ?>) center/cover no-repeat;padding:80px 0;color:#fff;">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-10">
				<div style="display:flex;gap:20px;align-items:center;padding:24px 28px;background:#fff5f6;border-left:4px solid #dc3545;border-radius:10px;margin-bottom:40px;">
					...
					<p style="margin:0;font-size:17px;line-height:1.6;color:#1a2332;font-style:italic;font-weight:500;">
						<?php murailles_t( "Fondée en 1062 par Youssef Ibn Tachfine, Marrakech a tour à tour été capitale des Almoravides, des Almohades et des Saadiens. La ville rouge tient son nom des remparts d'argile qui l'enserrent encore aujourd'hui." ); ?>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row justify-content-center mb-4">
			<div class="col-lg-7 text-center">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'Chronologie' ); ?></span>
				<h2 style="margin:0 0 12px;"><?php murailles_t( 'Une histoire millénaire' ); ?></h2>
				<p class="text-muted"><?php murailles_t( 'Les grandes dates qui ont façonné la ville rouge.' ); ?></p>
			</div>
		</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-10">
				...
				foreach ( $timeline as $i => $t ) :
					list( $year, $era, $icon, $desc, $color ) = $t;
				?>
...
<section class="py-5" style="background:#fafbfc;">
	<div class="container">
		<div class="row justify-content-center mb-4">
			<div class="col-lg-7 text-center">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'Patrimoine' ); ?></span>
				<h2 style="margin:0 0 12px;"><?php murailles_t( 'Monuments emblématiques' ); ?></h2>
				<p class="text-muted"><?php murailles_t( "Les joyaux architecturaux qui racontent l'histoire de la ville." ); ?></p>
			</div>
		</div>
