<?php
/**
 * Template Name: Half Map 2
 *
 * Auto-converted from half-map-2.html
								...
								<div class="sty_1523">
									<div class="_mp_filter center mb-3">
										...
										<div class="_mp_filter_last">
											<a href="#" class="map_filter min" data-bs-toggle="modal" data-bs-target="#filter"><i class="fa fa-sliders-h me-2"></i>Short Filter</a>
										</div>
									</div>
								...
								<div class="property-listing list_view">
									...
									<div class="list_view_flex">
										...
										<div class="price-features-wrapper">
											<div class="list-fx-features">
												<div class="listing-card-info-icon">
													<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'bed.svg' ) ); ?>" width="15" alt="" /></div>2 Beds
												</div>
												<div class="listing-card-info-icon">
													<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'bathtub.svg' ) ); ?>" width="15" alt="" /></div>1 Bath
												</div>
									...
									<div class="list_view_flex">
										...
										<div class="price-features-wrapper">
											<div class="list-fx-features">
												...
												<div class="listing-card-info-icon">
													<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="15" alt="" /></div>620 sqft
												</div>
											</div>
										</div>
