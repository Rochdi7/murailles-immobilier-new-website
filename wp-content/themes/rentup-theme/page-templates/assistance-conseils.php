...
$murailles_assistance_repeaters = murailles_page_editor_repeatable_defaults( 'page-templates/assistance-conseils.php' );
$murailles_assistance_stats = murailles_get_repeatable_meta(
	'_murailles_assistance_stats',
	isset( $murailles_assistance_repeaters['_murailles_assistance_stats'] ) ? $murailles_assistance_repeaters['_murailles_assistance_stats'] : array(),
	$murailles_assistance_page_id
);
$murailles_assistance_services = murailles_get_repeatable_meta(
	'_murailles_assistance_services',
	isset( $murailles_assistance_repeaters['_murailles_assistance_services'] ) ? $murailles_assistance_repeaters['_murailles_assistance_services'] : array(),
	$murailles_assistance_page_id
);
$murailles_assistance_steps = murailles_get_repeatable_meta(
	'_murailles_assistance_steps',
	isset( $murailles_assistance_repeaters['_murailles_assistance_steps'] ) ? $murailles_assistance_repeaters['_murailles_assistance_steps'] : array(),
	$murailles_assistance_page_id
);
$murailles_assistance_partner_icons = murailles_get_repeatable_meta(
	'_murailles_assistance_partner_icons',
	isset( $murailles_assistance_repeaters['_murailles_assistance_partner_icons'] ) ? $murailles_assistance_repeaters['_murailles_assistance_partner_icons'] : array(),
	$murailles_assistance_page_id
);
get_header();
?>
...
<?php get_template_part( 'template-parts/hero-page-title', null, array(
	'bg'       => $murailles_assistance_hero_bg,
	'eyebrow'  => $murailles_assistance_hero_eyebrow,
	'title'    => $murailles_assistance_hero_title,
	'subtitle' => $murailles_assistance_hero_subtitle,
) ); ?>
<?php endif; ?>
...
<section class="py-5">
	<div class="container">
		<div class="row g-4 justify-content-center">
			...
			foreach ( $murailles_assistance_stats as $s ) :
...
<section class="py-5" style="background:#fafbfc;">
	<div class="container">
		...
		<div class="row g-4">
			...
			foreach ( $murailles_assistance_services as $s ) :
				$icon  = isset( $s['icon_class'] ) ? $s['icon_class'] : '';
...
<section class="py-5">
	<div class="container">
		...
		<div class="row g-4">
			...
			foreach ( $murailles_assistance_steps as $st ) :
				$num   = isset( $st['number'] ) ? $st['number'] : '';
				$title = isset( $st['title'] ) ? $st['title'] : '';
				$desc  = isset( $st['description'] ) ? $st['description'] : '';
			?>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-5 text-center">
				<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:20px;">
					...
					foreach ( $murailles_assistance_partner_icons as $p ) :
						$p = isset( $p['icon_class'] ) ? $p['icon_class'] : '';
						?>
