...
<!-- ============================ Page Title ================================== -->
<div class="page-title tourisme-hero" style="background:linear-gradient(135deg,rgba(220,53,69,0.85),rgba(26,35,50,0.85)),url(<?php echo esc_url( murailles_img( 'tourisme-marrakech.webp' ) ); ?>) center/cover no-repeat;padding:100px 0;color:#fff;">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				<span style="display:inline-block;padding:6px 16px;background:rgba(255,255,255,0.15);border-radius:20px;font-size:13px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;backdrop-filter:blur(4px);margin-bottom:14px;"><?php murailles_t( 'Découvrir' ); ?></span>
				<h1 style="color:#fff;font-size:42px;font-weight:800;margin:0 0 12px;text-shadow:0 2px 10px rgba(0,0,0,0.2);"><?php murailles_t( 'Tourisme à Marrakech' ); ?></h1>
				<p style="color:rgba(255,255,255,0.92);font-size:17px;max-width:680px;margin:0 auto;line-height:1.6;"><?php murailles_t( 'La ville ocre vous ouvre ses portes : palais millénaires, jardins enchantés, gastronomie raffinée et désert mystique.' ); ?></p>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="row justify-content-center mb-4">
			<div class="col-lg-7 text-center">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'À ne pas manquer' ); ?></span>
				<h2 style="margin:0 0 12px;"><?php murailles_t( 'Lieux incontournables' ); ?></h2>
				<p class="text-muted"><?php murailles_t( 'Les sites emblématiques qui font le charme unique de Marrakech.' ); ?></p>
			</div>
		</div>
...
<section class="py-5">
	<div class="container">
		<div class="row justify-content-center mb-4">
			<div class="col-lg-7 text-center">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'Pratique' ); ?></span>
				<h2 style="margin:0 0 12px;"><?php murailles_t( 'Quand visiter Marrakech ?' ); ?></h2>
				<p class="text-muted"><?php murailles_t( 'Le climat de la ville ocre suit le rythme des saisons marocaines.' ); ?></p>
			</div>
		</div>
		...
		<div class="row g-3 justify-content-center">
			...
			foreach ( $seasons as $s ) :
				list( $name, $months, $temp, $icon, $color, $desc ) = $s;
			?>
...
<section class="py-5" style="background:linear-gradient(135deg,#1a2332,#0f161f);color:#fff;">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'Gastronomie' ); ?></span>
				<h2 style="color:#fff;margin:0 0 16px;"><?php murailles_t( 'Une cuisine de tradition' ); ?></h2>
				<p style="color:rgba(255,255,255,0.85);font-size:16px;line-height:1.7;"><?php murailles_t( "La cuisine marocaine, classée par l'UNESCO, est un voyage à elle seule. Tajines mijotés, couscous du vendredi, pâtisseries au miel et thé à la menthe : chaque plat raconte l'art de vivre marocain." ); ?></p>
			</div>
			<div class="col-lg-6">
