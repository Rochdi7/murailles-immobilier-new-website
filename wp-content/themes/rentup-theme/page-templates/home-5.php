 ...
 *
 * Auto-converted from home-5.html
...
<!-- ============================ Hero Banner  Start================================== -->
				...
				<div class="container">
					<div class="simple-search-wrap">
						<div class="hero_search-2">
							<h1 class="m-0">Find Your Dream</h1>
							<p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
								...
								<div class="tab-content" id="myTabContent">
									...
									<div class="tab-pane fade show active" id="buy" role="tabpanel" aria-labelledby="buy-tab">
										<div class="pk-input-group">
											<input type="text" name="email" class="email form-control" placeholder="Neighborhood, Street, City">
											<button class="pk-subscribe-submit bg-danger" type="submit">Search</button>
										</div>
									</div>
								...
								<ul class="_awards_lists four">
									...
									<li>
										<div class="_awards_list_wrap">
											<div class="_awards_list_thumb op-1"><img src="<?php echo esc_url( murailles_img( 'trust.png' ) ); ?>" class="img-fluid" alt="" /></div>
									...
									<li>
										<div class="_awards_list_wrap">
											<div class="_awards_list_thumb op-1"><img src="<?php echo esc_url( murailles_img( 'cap.png' ) ); ?>" class="img-fluid" alt="" /></div>
											<div class="_awards_list_caption">
												<h5>2018</h5>
									...
									<li>
										<div class="_awards_list_wrap">
											<div class="_awards_list_thumb op-1"><img src="<?php echo esc_url( murailles_img( 'clutch.png' ) ); ?>" class="img-fluid" alt="" /></div>
											<div class="_awards_list_caption">
												<h5>2017</h5>
												<span>IITCA Zio Award</span>
											</div>
										</div>
									</li>
									<!-- single list -->
			...
			<section class="image-cover" style="background:#122947 url(<?php echo esc_url( murailles_img( 'pattern.png' ) ); ?>) no-repeat;">
				<div class="container">
					...
					<div class="row justify-content-center gx-xl-3 gx-md-4 gx-4 gy-4">
						
						<!-- Single Location -->
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="grid_agents style-2">
								<div class="elio_mx_list theme-bg-2">13 Listings</div>
								<div class="grid_agents-wrap">
									...
									<div class="fr-grid-deatil">
										...
										<h5 class="fr-can-name"><a href="<?php echo esc_url( home_url( '/agent-page/' ) ); ?>">Carol B. Halton</a></h5>
									</div>
						...
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="grid_agents style-2">
								...
								<div class="grid_agents-wrap">
									...
									<div class="fr-grid-deatil">
										<span><i class="ti-location-pin me-1"></i>Liverpool, London</span>
										<h5 class="fr-can-name"><a href="<?php echo esc_url( home_url( '/agent-page/' ) ); ?>">Jason A. Burmeister</a></h5>
									</div>
						...
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="grid_agents style-2">
								<div class="elio_mx_list theme-bg-2">19 Listings</div>
								<div class="grid_agents-wrap">
									...
									<div class="fr-grid-deatil">
										<span><i class="ti-location-pin me-1"></i>California, USA</span>
										<h5 class="fr-can-name"><a href="<?php echo esc_url( home_url( '/agent-page/' ) ); ?>">Denver. Burmeister</a></h5>
									</div>
						...
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="grid_agents style-2">
								...
								<div class="grid_agents-wrap">
									...
									<div class="fr-grid-deatil">
										<span><i class="ti-location-pin me-1"></i>Denever, NewYork</span>
										<h5 class="fr-can-name"><a href="<?php echo esc_url( home_url( '/agent-page/' ) ); ?>">Lawanna K. Ruel</a></h5>
									</div>
					...
					<div class="row mt-5">
						<div class="col-lg-12 col-md-12 col-sm-12 text-center">
							<a href="<?php echo esc_url( home_url( '/agents/' ) ); ?>" class="btn btn-whites fw-medium text-danger rounded">Explore More Agents</a>
						</div>
					</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="grid_blog_box">
								...
								<div class="gtid_blog_thumb">
									...
									<div class="gtid_blog_info"><span>20</span>Oct 2021</div>
								</div>								
						...
						<div class="col-lg-4 col-md-6">
							<div class="grid_blog_box">
								...
								<div class="gtid_blog_thumb">
									...
									<div class="gtid_blog_info"><span>17</span>Dec 2021</div>
								</div>								
