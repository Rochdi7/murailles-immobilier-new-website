 ...
 *
 * Auto-converted from home-7.html
...
<!-- ============================ Hero Banner  Start================================== -->
			<div class="hero_banner image-cover" style="background:#f6f6f6 url(<?php echo esc_url( murailles_img( 'banner-home.jpg' ) ); ?>) no-repeat;" data-overlay="4">
				<div class="container">
					
					<h2 class="font-normal text-center mb-1">Best Real Estate Advice<br><strong>For Your <i class="theme-cl f-style">Agency</i></strong></h2>
					<div class="mb-4 text-mlixer text-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud</div>
								...
								<div class="full_search_box nexio_search lightanic_search hero_search-radius style-2">
									...
									<div class="row">
										...
										<div class="col-lg-5 col-md-5 col-sm-12 small-padd">
											<div class="form-group">
												<div class="input-with-icon">
													<input type="text" class="form-control b-0 b-r" placeholder="Neighborhood">
													<i class="ti-search"></i>
												</div>
											</div>
										</div>
										
										<div class="col-lg-5 col-md-4 col-sm-12 small-padd">
											<div class="form-group">
												<div class="input-with-icon">
										...
										<div class="col-lg-2 col-md-3 col-sm-12 small-padd">
											<div class="form-group">
												<a href="#" class="btn btn-seegreen full-width">Search</a>
											</div>
										</div>
					...
					<div class="row justify-content-center g-4">
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="wpk_process active">
								<div class="wpk_thumb">
									<div class="wpk_thumb_figure bg-seegreen">
				...
				<div class="container">
					...
					<div class="row justify-content-center g-4">
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="property-listing property-2 shadow-0 h-100">
								...
								<div class="listing-detail-footer">
									...
									<div class="footer-flex">
										<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-seegreen">View Detail</a>
									</div>
								</div>
							...
							<div class="property-listing property-2 shadow-0 h-100">
								...
								<div class="price-features-wrapper">
									<div class="list-fx-features">
										...
										<div class="listing-card-info-icon">
											<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="13" alt="" /></div>740 sqft
										</div>
									</div>
								</div>
							...
							<div class="property-listing property-2 shadow-0 h-100">
								...
								<div class="price-features-wrapper">
									<div class="list-fx-features">
										...
										<div class="listing-card-info-icon">
											<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="13" alt="" /></div>920 sqft
										</div>
									</div>
								</div>
							...
							<div class="property-listing property-2 shadow-0 h-100">
								...
								<div class="price-features-wrapper">
									<div class="list-fx-features">
										...
										<div class="listing-card-info-icon">
											<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'bathtub.svg' ) ); ?>" width="13" alt="" /></div>3 Bath
										</div>
										<div class="listing-card-info-icon">
							...
							<div class="property-listing property-2 shadow-0 h-100">
								...
								<div class="price-features-wrapper">
									<div class="list-fx-features">
										...
										<div class="listing-card-info-icon">
											<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="13" alt="" /></div>750 sqft
										</div>
									</div>
								</div>
					...
					<div class="row mt-5">
						<div class="col-lg-12 col-md-12 col-sm-12 text-center">
							<a href="<?php echo esc_url( home_url( '/list-layout-with-map/' ) ); ?>" class="btn btn-theme-light-2 rounded">Explore More Properties</a>
						</div>
					</div>
			...
			<!-- ============================ Top Agents ================================== -->
			<section class="image-cover min" style="background:#122947 url(<?php echo esc_url( murailles_img( 'pattern.png' ) ); ?>) no-repeat;">
				<div class="container">
							...
							<div class="item-slide space">
								...
								<div class="single_items">
									<div class="grid_agents style-2">
										<div class="elio_mx_list bg-seegreen z-1">20 Listings</div>
										<div class="grid_agents-wrap">
											...
											<div class="fr-infos-deatil">	
												...
												<a href="#" class="btn btn-seegreen"><i class="fa fa-phone"></i></a>
											</div>
								...
								<div class="single_items">
									<div class="grid_agents style-2">
										<div class="elio_mx_list bg-seegreen z-1">18 Listings</div>
										<div class="grid_agents-wrap">
								...
								<div class="single_items">
									<div class="grid_agents style-2">
										<div class="elio_mx_list bg-seegreen z-1">30 Listings</div>
										<div class="grid_agents-wrap">
								...
								<div class="single_items">
									<div class="grid_agents style-2">
										<div class="elio_mx_list bg-seegreen z-1">42 Listings</div>
										<div class="grid_agents-wrap">
								...
								<div class="single_items">
									<div class="grid_agents style-2">
										<div class="elio_mx_list bg-seegreen z-1">17 Listings</div>
										<div class="grid_agents-wrap">
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-8 col-sm-12">
							...
							<div class="tab_exclusive position-relative z-1">
								...
								<a href="#" class="btn exliou btn-seegreen mt-2">Find Properties</a>
							</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="grid_blog_box">
								...
								<div class="gtid_blog_thumb">
									...
									<div class="gtid_blog_info"><span>19</span>Sep 2021</div>
								</div>								
