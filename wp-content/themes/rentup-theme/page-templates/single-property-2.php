<?php
/**
 * Template Name: Single Property 2
 *
 * Auto-converted from single-property-2.html
						...
						<div class="col-lg-8 col-md-12 col-sm-12">
							...
							<div class="_prtis_list mb-4">
								<div class="_prtis_list_header">
									<ul>
										<li>
											<div class="content_thumb"><img src="<?php echo esc_url( murailles_img( 'bed.svg' ) ); ?>" alt="" /></div>
											<div class="content">
												<span class="dark">3 Bedrooms</span>
												<span class="title">Bedrooms</span>
											</div>
										</li>
										<li>
											<div class="content_thumb"><img src="<?php echo esc_url( murailles_img( 'bathtub.svg' ) ); ?>" alt="" /></div>
											<div class="content">
												<span class="dark">2 Bahrooms</span>
												<span class="title">Bathrooms</span>
											</div>
										</li>
										<li>
											<div class="content_thumb"><img src="<?php echo esc_url( murailles_img( 'b-1.jpg' ) ); ?>" alt="" /></div>
											<div class="content">
												<span class="dark">2812 Sq Ft</span>
								...
								<div class="_prtis_list_body">
									<ul class="deatil_features">
										<li><strong>2</strong>Garage</li>
										<li><strong>Apartment</strong>Property Type</li>
										<li><strong>1982</strong>Year Built</li>
										<li><strong>Active</strong>Status</li>
										<li><strong>Central A/C</strong>Cooling</li>
										<li><strong>Forced Air</strong>Heating Type</li>
										<li><strong>Kitchen Facilities</strong>Kitchen Features</li>
										<li><strong>Brick</strong>Exterior Finish</li>
										<li><strong>Yes</strong>Swimming Pool</li>
										<li><strong>Yes</strong>Elevetor</li>
										<li><strong>No</strong>Fireplace</li>
										<li><strong>No</strong>Free WiFi</li>
									</ul>
								</div>
							</div>
							...
							<div class="_prtis_list mb-4">
								<div class="_prtis_list_header min">
									<h4 class="m-0">About <span class="theme-cl">Property</span></h4>
								</div>
								<div class="_prtis_list_body">
							...
							<div class="_prtis_list mb-4">
								...
								<div class="_prtis_list_header min">
									<h4 class="m-0">Advance <span class="theme-cl">Features</span></h4>
								</div>
							...
							<div class="_prtis_list mb-4">
								...
								<div class="_prtis_list_header min">
									<h4 class="m-0">All <span class="theme-cl">Ameneties</span></h4>
								</div>
							...
							<div class="_prtis_list mb-4">
								...
								<div class="_prtis_list_header min">
									<h4 class="m-0">Property <span class="theme-cl">video</span></h4>
								</div>
							...
							<div class="_prtis_list mb-4">
								...
								<div class="_prtis_list_header min">
									<h4 class="m-0">Floor <span class="theme-cl">Plan</span></h4>
								</div>
									...
									<div class="accordion" id="floor-option">
										<div class="card">
											<div class="card-header" id="groundFloor">
												<h2 class="mb-0">
													<button type="button" class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#groundfloor">Ground Floor</button>									
												</h2>
										...
										<div class="card">
											<div class="card-header" id="firstFloor">
												<h2 class="mb-0">
													<button type="button" class="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#firstfloor">First Floor<span>710 sq ft</span></button>
												</h2>
												<div class="floor_listeo">
													<ul>
														<li>Beds: 4</li>
										...
										<div class="card">
											<div class="card-header" id="seconfFloor">
												<h2 class="mb-0">
													<button type="button" class="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#secondfloor">Second<span>520 sq ft</span></button>                     
												</h2>
												<div class="floor_listeo">
													<ul>
														<li>Beds: 5</li>
							...
							<div class="_prtis_list mb-4">
								...
								<div class="_prtis_list_header min">
									<h4 class="m-0">Property <span class="theme-cl">Location</span></h4>
								</div>
...
?>
							...
							<div class="_prtis_list mb-4">
								...
								<div class="_prtis_list_header min">
									<h4 class="m-0">12 Reviews <span class="theme-cl">Given</span></h4>
								</div>
							...
							<div class="_prtis_list mb-4">
								...
								<div class="_prtis_list_header min">
									<h4 class="m-0">Write a <span class="theme-cl">Review</span></h4>
								</div>
								...
								<div class="_prtis_list_body">
									<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group">
												<button class="btn btn-danger rounded" type="submit">Submit Review</button>
											</div>
										</div>
								...
								<div class="sider_blocks_wrap shadows">
									<div class="side-booking-header">
										<ul class="nav nav-pills sider_tab" id="pillss-tab" role="tablist">
										  <li class="nav-item">
											<a class="nav-link active" id="pills-book-tab" data-bs-toggle="pill" href="#pills-book" role="tab" aria-controls="pills-book" aria-selected="true">Book Now</a>
										  </li>
										  <li class="nav-item">
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-6 col-6">
															<div class="form-group">
																...
																<div class="cld-box">
																	<i class="ti-calendar"></i>
																	<input type="text" class="form-control" name="checkout" value="10/24/2020"/>
																</div>
															</div>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-6 col-6">
														...
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="stbooking-footer mt-1">
																<div class="form-group mb-0 pb-0">
																	<a href="#" class="btn btn-danger full-width fw-medium">Book It Now</a>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="tab-pane fade" id="pills-appointment" role="tabpanel" aria-labelledby="pills-appointment-tab">
												<div class="sider-block-body p-3">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="form-group">
																<button class="btn btn-danger full-width fw-medium">Make Appointment</button>
															</div>
														</div>
													</div>
												</div>
