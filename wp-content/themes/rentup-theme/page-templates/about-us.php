					...
					<div class="row justify-content-center">
						<div class="col-xl-7 col-lg-10 col-md-12 col-sm-12">
							<div class="text-center mb-5">
								<span class="text-light"><?php murailles_t( 'Nos distinctions' ); ?></span>
								<h2 class="font-weight-normal text-light"><?php murailles_t( "Des centaines de clients satisfaits qui continuent à nous faire confiance pour leurs projets immobiliers." ); ?></h2>
							</div>
						</div>
					</div>
