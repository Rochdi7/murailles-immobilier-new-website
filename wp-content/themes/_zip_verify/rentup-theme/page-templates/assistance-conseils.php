	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				<span style="display:inline-block;padding:6px 16px;background:rgba(255,255,255,0.15);border-radius:20px;font-size:13px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;backdrop-filter:blur(4px);margin-bottom:14px;"><?php murailles_t( 'Notre expertise' ); ?></span>
				<h1 style="color:#fff;font-size:42px;font-weight:800;margin:0 0 12px;text-shadow:0 2px 10px rgba(0,0,0,0.2);"><?php murailles_t( 'Assistance & Conseils' ); ?></h1>
				<p style="color:rgba(255,255,255,0.92);font-size:17px;max-width:680px;margin:0 auto;line-height:1.6;"><?php murailles_t( 'Un accompagnement personnalisé à chaque étape de votre projet immobilier au Maroc.' ); ?></p>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="row justify-content-center mb-4">
			<div class="col-lg-7 text-center">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'Services' ); ?></span>
				<h2 style="margin:0 0 12px;"><?php murailles_t( 'Notre accompagnement' ); ?></h2>
				<p class="text-muted"><?php murailles_t( "Murailles Immobilier vous accompagne de A à Z dans votre projet, depuis la première visite jusqu'à la remise des clés." ); ?></p>
			</div>
		</div>
...
<section class="py-5">
	<div class="container">
		<div class="row justify-content-center mb-4">
			<div class="col-lg-7 text-center">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'Processus' ); ?></span>
				<h2 style="margin:0 0 12px;"><?php murailles_t( 'Comment nous procédons' ); ?></h2>
				<p class="text-muted"><?php murailles_t( 'Une méthode éprouvée en 4 étapes pour sécuriser votre acquisition.' ); ?></p>
			</div>
		</div>
...
<section class="py-5" style="background:linear-gradient(135deg,#1a2332,#0f161f);color:#fff;">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-7">
				<span style="display:inline-block;color:#dc3545;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;font-size:13px;margin-bottom:8px;"><?php murailles_t( 'Notre réseau' ); ?></span>
				<h2 style="color:#fff;margin:0 0 14px;"><?php murailles_t( 'Des partenaires de confiance' ); ?></h2>
				<p style="color:rgba(255,255,255,0.85);font-size:16px;line-height:1.6;margin-bottom:24px;"><?php murailles_t( "Banques, notaires, architectes, bureaux d'études, experts-comptables, entrepreneurs, artisans : notre réseau de partenaires marocains met son savoir-faire à votre service pour chaque étape de votre projet immobilier." ); ?></p>
				<a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="btn btn-danger" style="padding:12px 28px;border-radius:8px;font-weight:600;">
					<i class="fa-solid fa-envelope"></i><?php murailles_t( 'Parlons de votre projet' ); ?>
				</a>
			</div>
