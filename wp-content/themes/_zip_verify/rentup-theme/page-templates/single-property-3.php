<?php
/**
 * Template Name: Single Property 3
 *
 * Auto-converted from single-property-3.html
						...
						<div class="col-lg-12 col-md-12">
							...
							<div class="property_lexible-1">
								<div class="pr-price-into flex-1">
									...
									<h2>5689 Resot Relly Market, Montreal Canada</h2>
								</div>
								<div class="price_into_last">
									<h2 class="text-seegreen">$7,420<span>USD/mo</span></h2>
									<div class="list-fx-features">
										<div class="listing-card-info-icon">
											<span><img src="<?php echo esc_url( murailles_img( 'bed.svg' ) ); ?>" alt="">3th</span>
										</div>
										<div class="listing-card-info-icon">
											<span><img src="<?php echo esc_url( murailles_img( 'bathtub.svg' ) ); ?>" alt="">2th</span>
										</div>
										<div class="listing-card-info-icon">
											<span><img src="<?php echo esc_url( murailles_img( 'b-1.jpg' ) ); ?>" alt="">124</span>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="property_block_wrap">
								...
								<div class="block-body">
									<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group">
												<button class="btn btn-danger full-width fw-medium" type="submit">Submit Review</button>
											</div>
										</div>
							...
							<div class="property-sidebar">
														...
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="stbooking-footer mt-1">
																<div class="form-group mb-0 pb-0">
																	<a href="#" class="btn btn-danger fw-medium full-width">Book It Now</a>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="tab-pane fade" id="pills-appointment" role="tabpanel" aria-labelledby="pills-appointment-tab">
												<div class="sider-block-body p-3">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="form-group">
																<button class="btn btn-danger fw-medium full-width">Make Appointment</button>
															</div>
														</div>
													</div>
												</div>
								...
								<div class="sider_blocks_wrap">
									<div class="side-booking-body">
										...
										<a href="#" class="agent-btn-contact" data-bs-toggle="modal" data-bs-target="#autho-message"><i class="ti-comment-alt"></i>Message</a>
