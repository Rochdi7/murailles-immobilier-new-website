<?php
/**
 * Template Name: Grid Layout 2
 *
 * Auto-converted from grid-layout-2.html
							...
							<div class="row justify-content-center g-4">
									...
									<div class="property-listing property-2">
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<h6 class="listing-card-info-price text-danger mb-0 p-0">$7,000</h6>
											</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="property-listing property-2">
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<h6 class="listing-card-info-price text-danger mb-0 p-0">$8,200</h6>
											</div>
											<div class="footer-flex">
												<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-seegreen">View Detail</a>
											</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="property-listing property-2">
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<h6 class="listing-card-info-price text-danger mb-0 p-0">$9,500</h6>
											</div>
											<div class="footer-flex">
												<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-seegreen">View Detail</a>
											</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="property-listing property-2">
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<h6 class="listing-card-info-price text-danger mb-0 p-0">$10,400</h6>
											</div>
											<div class="footer-flex">
												<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-seegreen">View Detail</a>
											</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="property-listing property-2">
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<h6 class="listing-card-info-price text-danger mb-0 p-0">$9,200</h6>
											</div>
											<div class="footer-flex">
												<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-seegreen">View Detail</a>
											</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="property-listing property-2">
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<h6 class="listing-card-info-price text-danger mb-0 p-0">$9,100</h6>
											</div>
											<div class="footer-flex">
												<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-seegreen">View Detail</a>
											</div>
