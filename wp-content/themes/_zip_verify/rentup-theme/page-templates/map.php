<?php
/**
 * Template Name: Map Home
 *
 * Auto-converted from map.html
			...
			<div class="home-map-banner full-wrapious">
				...
				<div class="advance-search-container">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<button data-bs-toggle="collapse" data-bs-target="#ad-search" class="btn adv-btn bg-danger">Advance Search</button>
											...
											<div class="search_hero_wrapping">
												...
												<div class="row">
													...
													<div class="col-lg-2 col-md-2 col-sm-12 small-padd">
														<div class="form-group none">
															<a href="#" class="btn search-btn btn-danger full-width">Search</a>
														</div>
													</div>
				...
				<div class="container">
					...
					<div class="row justify-content-center g-4">
							...
							<div class="property-listing property-2">
								...
								<div class="listing-detail-footer">
									<div class="footer-first">
										<h6 class="listing-card-info-price text-seegreen mb-0 p-0">$7,000</h6>
									</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="property-listing property-2">
								...
								<div class="listing-detail-footer">
									<div class="footer-first">
										<h6 class="listing-card-info-price text-seegreen mb-0 p-0">$8,200</h6>
									</div>
									<div class="footer-flex">
										<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-danger">View Detail</a>
									</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="property-listing property-2">
								...
								<div class="listing-detail-footer">
									<div class="footer-first">
										<h6 class="listing-card-info-price text-seegreen mb-0 p-0">$9,500</h6>
									</div>
									<div class="footer-flex">
										<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-danger">View Detail</a>
									</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="property-listing property-2">
								...
								<div class="listing-detail-footer">
									<div class="footer-first">
										<h6 class="listing-card-info-price text-seegreen mb-0 p-0">$10,400</h6>
									</div>
									<div class="footer-flex">
										<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-danger">View Detail</a>
									</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="property-listing property-2">
								...
								<div class="listing-detail-footer">
									<div class="footer-first">
										<h6 class="listing-card-info-price text-seegreen mb-0 p-0">$9,200</h6>
									</div>
									<div class="footer-flex">
										<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-danger">View Detail</a>
									</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="property-listing property-2">
								...
								<div class="listing-detail-footer">
									<div class="footer-first">
										<h6 class="listing-card-info-price text-seegreen mb-0 p-0">$9,100</h6>
									</div>
									<div class="footer-flex">
										<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-view bg-danger">View Detail</a>
									</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 text-center mt-4">
							<a href="<?php echo esc_url( home_url( '/list-layout-with-map/' ) ); ?>" class="btn btn-light-danger rounded">Explore More Properties</a>
						</div>
					</div>
							...
							<div class="item-slide space">
								...
								<div class="single_items">
									<div class="grid_agents">
										<div class="elio_mx_list bg-seegreen">102 Listings</div>
								...
								<div class="single_items">
									<div class="grid_agents">
										<div class="elio_mx_list bg-seegreen">72 Listings</div>
										<div class="grid_agents-wrap">
								...
								<div class="single_items">
									<div class="grid_agents">
										<div class="elio_mx_list bg-seegreen">22 Listings</div>
										<div class="grid_agents-wrap">
								...
								<div class="single_items">
									<div class="grid_agents">
										<div class="elio_mx_list bg-seegreen">50 Listings</div>
										<div class="grid_agents-wrap">
								...
								<div class="single_items">
									<div class="grid_agents">
										<div class="elio_mx_list bg-seegreen">42 Listings</div>
										<div class="grid_agents-wrap">
