 ...
 *
 * Auto-converted from agency-page.html
							...
							<div class="property_block_wraps">
								...
								<div class="property_block_wrap_header">
									<ul class="nav nav-pills tabs_system" id="pills-tab" role="tablist">
									  <li class="nav-item">
										<a class="nav-link active" id="pills-property-tab" data-bs-toggle="pill" href="#pills-property" role="tab" aria-controls="pills-property" aria-selected="true">Properties</a>
									  </li>
									  <li class="nav-item">
										<a class="nav-link" id="pills-agent-tab" data-bs-toggle="pill" href="#pills-agent" role="tab" aria-controls="pills-agent" aria-selected="false">Agent</a>
									  </li>
									</ul>
								</div>
											...
											<div class="tab-pane fade show active" id="pills-property" role="tabpanel" aria-labelledby="pills-property-tab">
												<div class="row justify-content-center g-4">
													...
													<div class="col-lg-6 col-md-6 col-sm-12">
														<div class="property-listing property-2 shadow-0">
														...
														<div class="grid_agents">
															...
															<div class="grid_agents-wrap">
																...
																<div class="fr-infos-deatil">	
																	<a href="#" class="btn btn-danger"><i class="fa fa-envelope me-2"></i>Message</a>
								...
								<div class="agency_gridio_wrap">
									...
									<div class="agency_gridio_caption">
										...
										<div class="agency_gridio_txt">
											...
											<a href="#" data-bs-toggle="modal" data-bs-target="#autho-message" class="vew_agency_btn">Send Message</a>	
										</div>
									</div>
								</div>
