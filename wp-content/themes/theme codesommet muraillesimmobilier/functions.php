...
// Multi-currency support for properties (MAD / EUR / USD) + front-office switcher.
...
// Security guard: blocks known spam/crack post payloads before they persist.
require_once get_template_directory() . '/inc/security-post-guard.php';
