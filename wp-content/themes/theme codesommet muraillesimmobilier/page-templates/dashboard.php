 ...
 *
 * Auto-converted from dashboard.html
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap position-relative z-1">
								...
								<h2 class="breadcrumb-title">Hello Adam, Welcome</h2>
							</div>
						...
						<div class="col-lg-3 col-md-4">
							<div class="property_dashboard_navbar">
								...
								<div class="dash_user_menues">
									<ul>
										<li class="active"><a href="<?php echo esc_url( home_url( '/dashboard/' ) ); ?>"><i class="fa fa-tachometer-alt"></i>Dashboard<span class="notti_coun style-1">4</span></a></li>
											...
											<div class="card-body p-0">
												<div class="table-responsive">
													<table class="table table-lg table-hover">
														...
														<tbody>
															<tr>
																<td><a href="#"><img src="<?php echo esc_url( murailles_img( 'p-1.png' ) ); ?>" class="rounded img-fluid me-2" width="80" alt="Avatar">Luxury House</a></td>
																<td>#258475</td>
															...
															<tr>
																<td><a href="#"><img src="<?php echo esc_url( murailles_img( 'p-2.png' ) ); ?>" class="rounded img-fluid me-2" width="80" alt="Avatar">Sargun Apartment</a></td>
																<td>#249578</td>
															...
															<tr>
																<td><a href="#"><img src="<?php echo esc_url( murailles_img( 'p-3.png' ) ); ?>" class="rounded img-fluid me-2" width="80" alt="Avatar">Preet Silver City</a></td>
																<td>#248712</td>
															...
															<tr>
																<td><a href="#"><img src="<?php echo esc_url( murailles_img( 'p-4.png' ) ); ?>" class="rounded img-fluid me-2" width="80" alt="Avatar">Mount See Villa</a></td>
																<td>#287246</td>
																<td><div class="label text-success bg-success-light">Paid</div></td>
																<td>$ 482.70</td>
																<td>06/09/2016</td>
