...
if ( ! function_exists( 'murailles_render_share_dock' ) ) {
	...
	function murailles_render_share_dock() {
		...
		?>
		<div class="murailles-share-dock" aria-label="<?php echo esc_attr( $label ); ?>">
			<span class="murailles-share-dock__label"><?php echo esc_html( $label ); ?></span>
			<a class="murailles-share-dock__link is-facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_attr( $share_url ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( murailles_t( 'Partager sur Facebook', false ) ); ?>">
				<i class="fa-brands fa-facebook-f" aria-hidden="true"></i>
			</a>
			<a class="murailles-share-dock__link is-x" href="https://twitter.com/intent/tweet?url=<?php echo esc_attr( $share_url ); ?>&text=<?php echo esc_attr( $share_title ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( murailles_t( 'Partager sur X', false ) ); ?>">
				<i class="fa-brands fa-x-twitter" aria-hidden="true"></i>
			</a>
			<a class="murailles-share-dock__link is-whatsapp" href="https://wa.me/?text=<?php echo esc_attr( $share_title ); ?>%20<?php echo esc_attr( $share_url ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( murailles_t( 'Partager sur WhatsApp', false ) ); ?>">
				<i class="fa-brands fa-whatsapp" aria-hidden="true"></i>
			</a>
			<a class="murailles-share-dock__link is-linkedin" href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo esc_attr( $share_url ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( murailles_t( 'Partager sur LinkedIn', false ) ); ?>">
				<i class="fa-brands fa-linkedin-in" aria-hidden="true"></i>
			</a>
		</div>
		<style>
			.murailles-share-dock{
				position:fixed;
				right:18px;
				bottom:18px;
				z-index:9998;
			...
			.murailles-share-dock__label{
				color:#fff;
				font-size:13px;
				font-weight:700;
				padding-inline-end:4px;
			}
			.murailles-share-dock__link{
				width:36px;
				height:36px;
				border-radius:50%;
				display:inline-flex;
			...
			.murailles-share-dock__link:hover{
				transform:translateY(-2px);
				opacity:.92;
				color:#fff;
			}
			.murailles-share-dock__link.is-facebook{ background:#1877f2; }
			.murailles-share-dock__link.is-x{ background:#111827; }
			.murailles-share-dock__link.is-whatsapp{ background:#25d366; }
			.murailles-share-dock__link.is-linkedin{ background:#0a66c2; }
