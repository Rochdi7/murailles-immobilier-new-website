 ...
 * Injected directly in <head> on the public site only.
 */
add_action('wp_head', function () {
	if ( is_admin() ) { return; }
	if ( current_user_can('manage_options') ) { return; }

	echo "<!-- Ahrefs Web Analytics -->\n";
	echo '<script src="https://analytics.ahrefs.com/analytics.js" data-key="SDPmEZ3zIx9tgIMleXrWZg" async></script>' . "\n";
	echo "<!-- End Ahrefs Web Analytics -->\n";
}, 4);
