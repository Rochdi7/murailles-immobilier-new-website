 ...
 *
 * Auto-converted from agent-page.html
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap position-relative z-1">
								...
								<h2 class="breadcrumb-title">Isvalia truek - USA</h2>
							</div>
				...
				<div class="container">
					<div class="row">
							...
							<div class="row justify-content-center g-4">
									...
									<div class="property-listing property-2">
										...
										<div class="price-features-wrapper">
											<div class="list-fx-features">
												...
												<div class="listing-card-info-icon">
													<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="15" alt="" /></div>820 sqft
												</div>
											</div>
										</div>
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<div class="foot-location"><img src="<?php echo esc_url( murailles_img( 'pin.svg' ) ); ?>" width="18" alt="" />Montreal, Canada</div>
											</div>
											<div class="footer-flex">
												<ul class="selio_style">
													<li>
														<div class="prt_saveed_12lk">
															<label class="toggler toggler-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Save property"><input type="checkbox"><i class="fa-solid fa-heart"></i></label>
														</div>
													</li>
													<li>
														<div class="prt_saveed_12lk">
															<a href="<?php echo esc_url( home_url( '/compare-property/' ) ); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Compare property"><i class="fa-solid fa-share"></i></a>
														</div>
													</li>
													<li>
														<div class="prt_saveed_12lk">
															<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View Property"><i class="fa-regular fa-circle-right"></i></a>
														</div>
													</li>
												</ul>
											</div>
									...
									<div class="property-listing property-2">
										...
										<div class="price-features-wrapper">
											<div class="list-fx-features">
												...
												<div class="listing-card-info-icon">
													<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="15" alt="" /></div>700 sqft
												</div>
											</div>
										</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="property-listing property-2">
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<div class="foot-location"><img src="<?php echo esc_url( murailles_img( 'pin.svg' ) ); ?>" width="18" alt="" />California, USA</div>
											</div>
											<div class="footer-flex">
												<ul class="selio_style">
													<li>
									...
									<div class="property-listing property-2">
										...
										<div class="price-features-wrapper">
											<div class="list-fx-features">
												...
												<div class="listing-card-info-icon">
													<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="15" alt="" /></div>950 sqft
												</div>
											</div>
										</div>
										...
										<div class="listing-detail-footer">
											<div class="footer-first">
												<div class="foot-location"><img src="<?php echo esc_url( murailles_img( 'pin.svg' ) ); ?>" width="18" alt="" />Denever, New York</div>
											</div>
											<div class="footer-flex">
												<ul class="selio_style">
													<li>
						...
						<div class="col-lg-4 col-md-12 col-sm-12">
							<div class="property-sidebar lg-mt-0 mt-4">
