...
( function () {
	...
	function render() {
		...
		var fallback = 'data:image/svg+xml;utf8,' + encodeURIComponent(
			'<svg xmlns="http://www.w3.org/2000/svg" width="240" height="140" viewBox="0 0 240 140"><rect width="240" height="140" fill="#e9ecef"/><text x="120" y="74" text-anchor="middle" fill="#adb5bd" font-family="Arial" font-size="13">Aucune image</text></svg>'
		);
