									...
									<div class="frm_submit_wrap">
										<div class="form-row row">
											...
											<div class="form-group col-md-3">
												...
												<input type="text" name="price" class="form-control" placeholder="<?php echo esc_attr( murailles_t( 'Montant', false ) ); ?>">
											</div>

											<div class="form-group col-md-3">
												<label><?php murailles_t( 'Devise' ); ?></label>
												<select name="currency" class="form-control">
													<?php
													$submit_default_currency = function_exists( 'murailles_default_currency' ) ? murailles_default_currency() : 'MAD';
													foreach ( murailles_get_currencies() as $cur_code => $cur_data ) :
													?>
													<option value="<?php echo esc_attr( $cur_code ); ?>" <?php selected( $submit_default_currency, $cur_code ); ?>><?php echo esc_html( $cur_data['label'] ); ?></option>
													<?php endforeach; ?>
												</select>
											</div>
