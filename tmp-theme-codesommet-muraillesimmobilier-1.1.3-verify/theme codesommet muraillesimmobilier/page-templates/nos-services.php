...
$murailles_services_page_id = get_the_ID();

$murailles_services_hero_bg = murailles_page_section_image_url( 'hero_bg_image_id', murailles_img( 'nos-services-immobilier-marrakech.webp' ), $murailles_services_page_id, true );
...
$murailles_services_callout_text = murailles_page_section_meta( 'callout_text', "Une approche globale et sécurisante pour votre projet de vie ou d'investissement." );
$murailles_services_repeaters = murailles_page_editor_repeatable_defaults( 'page-templates/nos-services.php' );
$murailles_services_cards = murailles_get_repeatable_meta(
	'_murailles_services_cards',
	isset( $murailles_services_repeaters['_murailles_services_cards'] ) ? $murailles_services_repeaters['_murailles_services_cards'] : array(),
	$murailles_services_page_id
);
get_header();
?>

<!-- ============================ Page Title ================================== -->
<?php if ( murailles_page_section_is_visible( 'hero', $murailles_services_page_id ) ) : ?>
<?php get_template_part( 'template-parts/hero-page-title', null, array(
	'bg'                  => $murailles_services_hero_bg,
	'eyebrow'             => $murailles_services_hero_eyebrow,
	'title'               => $murailles_services_hero_title,
	'subtitle'            => $murailles_services_hero_subtitle,
	'allow_html_subtitle' => true,
) ); ?>
<?php endif; ?>

<!-- ============================ Intro ================================== -->
<?php if ( murailles_page_section_is_visible( 'intro', $murailles_services_page_id ) ) : ?>
<section class="py-5">
	<div class="container">
...
<section class="pb-5">
	<div class="container">
		<div class="row g-4">
			...
			foreach ( $murailles_services_cards as $s ) :
		...
		<?php if ( murailles_page_section_is_visible( 'callout', $murailles_services_page_id ) ) : ?>
		<div class="row mt-5">
			<div class="col-lg-12">
				<div style="padding:28px 36px;background:#1a2332;color:#fff;border-radius:12px;text-align:center;">
					...
					<p style="margin:0;font-size:20px;font-weight:600;line-height:1.5;"><?php echo esc_html( $murailles_services_callout_text ); ?></p>
				</div>
			</div>
		</div>
		<?php endif; ?>
