 ...
 *   $args['stats']    (array)  Optional chip row, each item: ['icon'=>'fa-*','text'=>'…'].
 *
...
$murailles_hero_stats    = ( isset( $args['stats'] ) && is_array( $args['stats'] ) ) ? $args['stats'] : array();
?>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 position-relative z-1">
				<div class="_page_tetio">
					...
					<?php endif; ?>
					<?php if ( $murailles_hero_stats ) : ?>
					<div class="_page_tetio_stats">
						<?php foreach ( $murailles_hero_stats as $murailles_stat ) : ?>
						<span><i class="fa-solid <?php echo esc_attr( $murailles_stat['icon'] ); ?> me-1"></i><?php echo esc_html( $murailles_stat['text'] ); ?></span>
						<?php endforeach; ?>
					</div>
					<?php endif; ?>
				</div>
