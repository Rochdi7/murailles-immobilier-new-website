<?php
/**
 * Template Name: Grid Layout With Sidebar
 *
 * Auto-converted from grid-layout-with-sidebar.html
											...
											<div class="listing-short-detail-wrap">
												<div class="_card_list_flex mb-2">
													...
													<div class="_card_flex_last">
														<h6 class="listing-card-info-price text-seegreen mb-0">$6,700</h6>
													</div>
												</div>
										...
										<div class="listing-detail-wrapper">
											<div class="listing-short-detail-wrap">
												<div class="_card_list_flex mb-2">
													...
													<div class="_card_flex_last">
														<h6 class="listing-card-info-price text-seegreen mb-0">$6,900</h6>
													</div>
												</div>
												<div class="_card_list_flex">
													<div class="_card_flex_01">
										...
										<div class="listing-detail-wrapper">
											<div class="listing-short-detail-wrap">
												<div class="_card_list_flex mb-2">
													...
													<div class="_card_flex_last">
														<h6 class="listing-card-info-price text-seegreen mb-0">$8,500</h6>
													</div>
												</div>
												<div class="_card_list_flex">
													<div class="_card_flex_01">
										...
										<div class="listing-detail-wrapper">
											<div class="listing-short-detail-wrap">
												<div class="_card_list_flex mb-2">
													...
													<div class="_card_flex_last">
														<h6 class="listing-card-info-price text-seegreen mb-0">$7,900</h6>
													</div>
												</div>
												<div class="_card_list_flex">
													<div class="_card_flex_01">
										...
										<div class="listing-detail-wrapper">
											<div class="listing-short-detail-wrap">
												<div class="_card_list_flex mb-2">
													...
													<div class="_card_flex_last">
														<h6 class="listing-card-info-price text-seegreen mb-0">$1,200</h6>
													</div>
												</div>
												<div class="_card_list_flex">
													<div class="_card_flex_01">
