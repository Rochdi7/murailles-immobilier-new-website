	...
	switch ( $template_key ) {
		...
		case 'page-templates/about-us.php':
			return array(
				...
				'story_button_label'    => murailles_t( 'Contacter notre agence', false ),
				'story_button_url'      => home_url( '/contact/' ),
				'story_image_id'        => murailles_img( 'aboutus murailles immobilier.jpeg' ),
				...
				'awards_eyebrow'        => murailles_t( 'Nos chiffres clés', false ),
				'awards_heading'        => murailles_t( 'Des repères concrets sur notre accompagnement immobilier à Marrakech et dans tout le Maroc.', false ),
				'testimonials_heading'  => murailles_t( 'Avis de nos clients', false ),
				'testimonials_subtitle' => murailles_t( 'Découvrez les témoignages de propriétaires et acheteurs qui nous ont fait confiance pour leur projet immobilier au Maroc.', false ),
				'blog_heading'          => murailles_t( 'Actualités & Articles', false ),
				'blog_subtitle'         => murailles_t( 'Conseils, tendances du marché et guides pour acheter, vendre ou louer votre bien immobilier au Maroc.', false ),
		...
		case 'page-templates/contact.php':
			return array(
				...
				'phone_value'       => '+212 (0) 6 61 66 51 61',
			...
			return array(
				'_murailles_services_cards' => array(
					array(
						...
						'title'       => "Riads & maisons d'hôtes",
						'description' => 'Un large choix dans la médina, la Kasbah ou dans les alentours de Marrakech.',
					),
					array(
						'icon_class'  => 'fa-building',
						'title'       => 'Appartements & villas',
						'description' => 'À vendre ou à louer dans les quartiers de Guéliz et Hivernage.',
					),
					array(
						'icon_class'  => 'fa-utensils',
						'title'       => 'Commerces & restaurants',
						'description' => 'À vendre ou à louer, courte ou longue durée.',
					),
					array(
						'icon_class'  => 'fa-map-location-dot',
						'title'       => 'Terrains à bâtir',
						'description' => "Route de l'Ourika, Amezmiz, Tahennaoute, Sidi Abdellah Ghiat, Fès, Ouarzazate, Bab Atlas, Palmeraie, Amelkis…",
					),
					array(
						'icon_class'  => 'fa-chart-line',
						'title'       => 'Gestion & promotion',
						'description' => 'Ne laissez plus vos biens vacants — rentabilisez-les avec notre service de gestion locative.',
					),
					array(
						'icon_class'  => 'fa-handshake',
						'title'       => 'Accompagnement A à Z',
						'description' => 'Négociation, ouverture de compte, compromis, crédit, acte de vente, clauses suspensives, bail…',
					),
				),
			);
		case 'page-templates/assistance-conseils.php':
			return array(
				...
				'_murailles_assistance_services' => array(
					array(
						...
						'title'       => murailles_t( 'Recherche personnalisée', false ),
						'description' => murailles_t( 'Nous identifions les biens correspondant exactement à vos critères : ville, quartier, surface, budget et style architectural.', false ),
					),
					array(
						'icon_class'  => 'fa-handshake',
						'title'       => murailles_t( 'Négociation au juste prix', false ),
						'description' => murailles_t( "Forte de 15 ans d'expérience locale, notre équipe négocie chaque transaction pour obtenir les meilleures conditions.", false ),
					),
					array(
						'icon_class'  => 'fa-file-signature',
						'title'       => murailles_t( 'Démarches juridiques', false ),
						'description' => murailles_t( 'Compromis de vente, clauses suspensives, acte authentique : nous coordonnons notaire, avocat et expert pour une transaction sécurisée.', false ),
					),
					array(
						'icon_class'  => 'fa-building-columns',
						'title'       => murailles_t( 'Financement bancaire', false ),
						'description' => murailles_t( 'Réseau de partenaires bancaires marocains pour obtenir un crédit immobilier adapté à votre profil (résident et non-résident).', false ),
					),
					array(
						'icon_class'  => 'fa-key',
						'title'       => murailles_t( 'Remise des clés', false ),
						'description' => murailles_t( 'Coordination avec syndic, copropriété, services publics. Vous récupérez un bien prêt à vivre ou à louer.', false ),
					),
					array(
						'icon_class'  => 'fa-trowel-bricks',
						'title'       => murailles_t( 'Travaux & rénovation', false ),
						'description' => murailles_t( "Architectes, maîtres d'œuvre, artisans : nous orchestrons les chantiers de rénovation, traditionnels et contemporains.", false ),
					),
					array(
						'icon_class'  => 'fa-chart-line',
						'title'       => murailles_t( 'Gestion locative', false ),
						'description' => murailles_t( 'Mise en location, sélection des locataires, encaissement des loyers, état des lieux : votre patrimoine rentabilisé sans tracas.', false ),
					),
					array(
						'icon_class'  => 'fa-shield-halved',
						'title'       => murailles_t( 'Conseil patrimonial', false ),
						'description' => murailles_t( 'Optimisation fiscale, succession, démembrement : nos partenaires experts-comptables vous guident sur la durée.', false ),
					),
				),
				'_murailles_assistance_steps' => array(
					array(
						...
						'description' => murailles_t( 'Échange téléphonique ou en agence pour cerner votre projet, votre budget et vos critères.', false ),
					),
					array(
						'number'      => '02',
						'title'       => murailles_t( 'Visites ciblées', false ),
						'description' => murailles_t( 'Sélection de 3 à 5 biens correspondant à vos attentes, accompagnement sur chaque visite.', false ),
					),
					array(
						'number'      => '03',
						'title'       => murailles_t( 'Offre & négociation', false ),
						'description' => murailles_t( "Rédaction de l'offre d'achat, négociation du prix et des conditions avec le vendeur.", false ),
					),
					array(
						'number'      => '04',
						'title'       => murailles_t( 'Signature & remise', false ),
						'description' => murailles_t( "Coordination avec le notaire, signature de l'acte définitif, remise des clés.", false ),
					),
				),
				'_murailles_assistance_partner_icons' => array(
			...
			return array(
				'_murailles_histoire_timeline' => array(
					array(
						...
						'icon_class'  => 'fa-flag',
						'description' => murailles_t( 'Fondation par Youssef Ibn Tachfine, première capitale du Maroc.', false ),
						'color'       => '#dc3545',
					),
					array(
						'year'        => '1147',
						...
						'description' => murailles_t( "Construction de la Koutoubia, chef-d'œuvre de l'architecture islamique.", false ),
						'color'       => '#0e8763',
					),
					array(
						'year'        => '1269',
						'title'       => murailles_t( 'Mérinides', false ),
						'icon_class'  => 'fa-book-quran',
						'description' => murailles_t( 'Période de transition, déplacement de la capitale à Fès.', false ),
						'color'       => '#856404',
					),
					array(
						'year'        => '1554',
						...
						'icon_class'  => 'fa-crown',
						'description' => murailles_t( "Âge d'or : palais El Badi, tombeaux saadiens, médersa Ben Youssef.", false ),
						'color'       => '#dc3545',
					),
					array(
						'year'        => '1672',
						...
						'description' => murailles_t( 'Moulay Ismaïl démantèle El Badi pour construire Meknès.', false ),
						'color'       => '#0e8763',
					),
					array(
						'year'        => '1912',
						...
						'icon_class'  => 'fa-building',
						'description' => murailles_t( 'Création du quartier Guéliz, urbanisme à la française.', false ),
						'color'       => '#856404',
					),
					array(
						'year'        => '1985',
						...
						'icon_class'  => 'fa-award',
						'description' => murailles_t( "La médina inscrite au patrimoine mondial de l'UNESCO.", false ),
						'color'       => '#dc3545',
					),
					array(
						'year'        => '2025',
				...
				'_murailles_histoire_monuments' => array(
					array(
						'title'       => 'Koutoubia',
						'date'        => '1147',
						'description' => murailles_t( 'Minaret almohade de 77 m, modèle de la Giralda de Séville.', false ),
						'icon_class'  => 'fa-mosque',
					),
					array(
						'title'       => murailles_t( 'Palais El Badi', false ),
						'date'        => '1578',
						'description' => murailles_t( "Vestiges du palais saadien, surnommé l'Incomparable.", false ),
						'icon_class'  => 'fa-landmark',
					),
					array(
						'title'       => murailles_t( 'Médersa Ben Youssef', false ),
						'date'        => '1565',
						'description' => murailles_t( 'Plus grande école coranique du Maghreb, zelliges et stucs raffinés.', false ),
						'icon_class'  => 'fa-book-quran',
					),
					array(
						'title'       => murailles_t( 'Tombeaux saadiens', false ),
						'date'        => '1557',
						'description' => murailles_t( 'Nécropole royale aux 66 sépultures, redécouverte en 1917.', false ),
					...
					array(
						...
						'date'        => '1126',
						'description' => murailles_t( '19 km de murailles en pisé rouge, percées de 9 portes.', false ),
						'icon_class'  => 'fa-archway',
					),
				),
			);
			...
			return array(
				'_murailles_tourisme_infos' => array(
					array(
						...
						'value'      => '22°C',
						'label'      => murailles_t( "Climat doux toute l'année", false ),
					),
					array(
					...
					array(
						...
						'value'      => 'FR/AR/EN',
						'label'      => murailles_t( 'Langues parlées', false ),
					),
					array(
						'icon_class' => 'fa-clock',
						'value'      => 'GMT+1',
				...
				'_murailles_tourisme_places' => array(
					array(
						'title'       => 'Jemaa el-Fna',
						'description' => murailles_t( "Place mythique inscrite à l'UNESCO. Conteurs, charmeurs de serpents, gastronomie de rue à la nuit tombée.", false ),
						'tag'         => murailles_t( 'Patrimoine UNESCO', false ),
						'icon_class'  => 'fa-mug-hot',
					),
					array(
						'title'       => murailles_t( 'Souks de la Médina', false ),
						'description' => murailles_t( "Labyrinthe d'artisans : zelliges, cuirs, épices, tapis berbères et lanternes ciselées.", false ),
					...
					array(
						...
						'tag'         => murailles_t( 'Jardin & Musée', false ),
						'icon_class'  => 'fa-leaf',
					),
					array(
						'title'       => 'Ménara',
					...
					array(
						...
						'description' => murailles_t( "Joyau de l'architecture marocaine du XIXe siècle : 8 ha de patios, riads et plafonds peints.", false ),
						'tag'         => murailles_t( 'Palais', false ),
						'icon_class'  => 'fa-landmark',
					),
					array(
						'title'       => murailles_t( 'Médersa Ben Youssef', false ),
						'description' => murailles_t( 'Ancienne école coranique aux décors de zelliges, stucs et bois de cèdre sculpté.', false ),
						'tag'         => murailles_t( 'Monument', false ),
						'icon_class'  => 'fa-book-quran',
					),
					array(
						'title'       => murailles_t( "Vallée de l'Ourika", false ),
						'description' => murailles_t( 'Excursion à 1h : cascades, villages berbères, marché du lundi à Tnine, randonnées en montagne.', false ),
						'tag'         => murailles_t( 'Excursion', false ),
						'icon_class'  => 'fa-mountain',
					),
					array(
						'title'       => murailles_t( "Désert d'Agafay", false ),
						'description' => murailles_t( 'Désert de pierres à 30 min de la ville. Bivouacs sous les étoiles, balades en chameau et 4x4.', false ),
						'tag'         => murailles_t( 'Aventure', false ),
						'icon_class'  => 'fa-sun',
					),
					array(
						'title'       => 'Essaouira',
						'description' => murailles_t( 'Cité atlantique à 2h30 de route : ramparts portugais, port de pêche, surf et alizés.', false ),
						'tag'         => murailles_t( 'Côte atlantique', false ),
						'icon_class'  => 'fa-water',
					),
				),
				'_murailles_tourisme_seasons' => array(
					array(
						...
						'color'       => '#0e8763',
						'description' => murailles_t( 'Saison idéale : journées chaudes, soirées fraîches, jardins en fleurs.', false ),
					),
					array(
						'title'       => murailles_t( 'Été', false ),
						'months'      => murailles_t( 'Juin-Août', false ),
						'temperature' => '28-40°C',
						'icon_class'  => 'fa-sun',
						'color'       => '#f9b704',
						'description' => murailles_t( 'Très chaud en journée. Préférer les riads avec piscine et siestes en patio.', false ),
					),
					array(
						...
						'color'       => '#dc3545',
						'description' => murailles_t( 'Lumière dorée magnifique, températures douces. Excellent pour les randonnées.', false ),
					),
					array(
						'title'       => murailles_t( 'Hiver', false ),
						'months'      => murailles_t( 'Déc-Février', false ),
						'temperature' => '8-18°C',
						'icon_class'  => 'fa-snowflake',
						'color'       => '#3b82f6',
						'description' => murailles_t( "Doux en journée, frais le soir. L'Atlas sous la neige se visite à 1h30.", false ),
					),
				),
				'_murailles_tourisme_dishes' => array(
					array(
						...
						'description' => murailles_t( 'Agneau aux pruneaux, poulet citron-olives, kefta aux œufs.', false ),
					),
					array(
						'title'       => murailles_t( 'Couscous', false ),
						'icon_class'  => 'fa-utensils',
						'description' => murailles_t( 'Le grain roi du vendredi, accompagné de 7 légumes et viande.', false ),
					),
					array(
						'title'       => murailles_t( 'Pastilla', false ),
						'icon_class'  => 'fa-cookie-bite',
						'description' => murailles_t( 'Feuilletée sucrée-salée au pigeon ou au poisson.', false ),
					),
					array(
						'title'       => murailles_t( 'Thé menthe', false ),
						'icon_class'  => 'fa-mug-hot',
						'description' => murailles_t( "Versé de haut, symbole de l'hospitalité marocaine.", false ),
					),
				),
			);
		default:
...
function murailles_get_testimonials_meta_for_page( $meta_key, $default = array(), $post_id = 0 ) {
	$post_id = $post_id ? absint( $post_id ) : get_the_ID();
	$stored  = $post_id ? get_post_meta( $post_id, $meta_key, true ) : array();

	if ( is_array( $stored ) && ! empty( $stored ) ) {
		return murailles_get_repeatable_meta( $meta_key, $default, $post_id );
	}

	if ( function_exists( 'murailles_get_theme_option_testimonials' ) ) {
		return murailles_get_theme_option_testimonials( '', is_array( $default ) ? $default : array() );
	}
				...
				<div class="murailles-repeater-grid">
					<?php foreach ( $field['fields'] as $subfield ) : ?>
						...
						<div class="murailles-repeater-field murailles-repeater-field--<?php echo esc_attr( $sub_type ); ?>">
							...
							<?php elseif ( 'number' === $sub_type ) : ?>
								<input class="regular-text" type="text" inputmode="decimal" pattern="[0-9]+([\\.,][0-9]+)?" name="<?php echo esc_attr( $input_name ); ?>" id="<?php echo esc_attr( $input_id ); ?>" value="<?php echo esc_attr( $stored_value ); ?>" />
							<?php else : ?>
								<input class="regular-text<?php echo 'url' === $sub_type ? ' code' : ''; ?>" type="<?php echo esc_attr( $sub_type ); ?>" name="<?php echo esc_attr( $input_name ); ?>" id="<?php echo esc_attr( $input_id ); ?>" value="<?php echo esc_attr( $stored_value ); ?>" />
							<?php endif; ?>
						</div>
					<?php endforeach; ?>
				</div>
		...
		foreach ( $definitions[ $meta_key ]['fields'] as $field ) {
			...
			switch ( $field_type ) {
				...
				case 'image':
					...
					break;
				case 'number':
					$value = function_exists( 'murailles_sanitize_rating_value' )
						? murailles_sanitize_rating_value( $value, 5, true )
