 ...
 *
 * Auto-converted from messages.html
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								...
								<h2 class="breadcrumb-title">All Chats & Messages</h2>
							</div>
							...
							<div class="property_dashboard_navbar">
								...
								<div class="dash_user_menues">
									<ul>
										...
										<li class="active"><a href="<?php echo esc_url( home_url( '/messages/' ) ); ?>"><i class="fa fa-envelope"></i>Messages<span class="notti_coun style-3">3</span></a></li>
								...
								<div class="messages-container-inner">
									...
									<div class="dash-msg-inbox">
										<ul>
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-1.jpg' ) ); ?>" alt=""><span class="_user_status online"></span></div>
											...
											<li class="active-message">
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-2.jpg' ) ); ?>" alt=""><span class="_user_status offline"></span></div>
											...
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-3.jpg' ) ); ?>" alt=""><span class="_user_status busy"></span></div>
											...
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-4.jpg' ) ); ?>" alt=""><span class="_user_status online"></span></div>
											...
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-5.jpg' ) ); ?>" alt=""><span class="_user_status busy"></span></div>
											...
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-3.jpg' ) ); ?>" alt=""><span class="_user_status online"></span></div>
											...
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-4.jpg' ) ); ?>" alt=""><span class="_user_status busy"></span></div>
											...
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-1.jpg' ) ); ?>" alt=""><span class="_user_status offline"></span></div>
											...
											<li>
												<a href="#">
													<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'team-2.jpg' ) ); ?>" alt=""><span class="_user_status online"></span></div>
									...
									<div class="dash-msg-content">
										...
										<div class="message-plunch">
											<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'user-5.jpg' ) ); ?>" alt=""></div>
										...
										<div class="message-plunch me">
											<div class="dash-msg-avatar"><img src="<?php echo esc_url( murailles_img( 'user-3.jpg' ) ); ?>" alt=""></div>
										...
										<div class="message-reply">
											<textarea cols="40" rows="3" class="form-control with-light rounded" placeholder="Your Message"></textarea>
