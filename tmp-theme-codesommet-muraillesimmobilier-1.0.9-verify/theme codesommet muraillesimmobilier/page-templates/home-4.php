 ...
 *
 * Auto-converted from home-4.html
...
<!-- ============================ Hero Banner  Start================================== -->
			<div class="home-slider margin-bottom-0">
				...
				<!-- Slide -->
				<div data-background-image="<?php echo esc_url( murailles_img( 'slider-1.jpg' ) ); ?>" class="item">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="home-slider-container">
									...
									<div class="home-slider-desc">
										<div class="home-slider-title">
											...
											<h3>Find Your Best<br><span class="trans_text">Dream City</span></h3>
										</div>

										<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="read-more bg-danger">Browse Dream Place<i class="fa fa-arrow-right ms-2"></i></a>
									</div>
									<!-- Slide Title / End -->
				...
				<!-- Slide -->
				<div data-background-image="<?php echo esc_url( murailles_img( 'slider-2.jpg' ) ); ?>" class="item">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="home-slider-container">
				...
				<!-- Slide -->
				<div data-background-image="<?php echo esc_url( murailles_img( 'slider-4.jpg' ) ); ?>" class="item">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="home-slider-container">
				...
				<!-- Slide -->
				<div data-background-image="<?php echo esc_url( murailles_img( 'slider-5.jpg' ) ); ?>" class="item">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="home-slider-container">
					...
					<div class="row justify-content-center g-4">
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="wpk_process active">
								<div class="wpk_thumb">
									<div class="wpk_thumb_figure">
										<img src="<?php echo esc_url( murailles_img( 'banner-home.jpg' ) ); ?>" class="img-fluid" alt="" />
									</div>
								</div>
								<div class="wpk_caption">
								...
								<div class="single_items">
									<div class="row g-4">
										...
										<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
											<div class="property-listing list_view h-100 m-0 shadow-0">
										...
										<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
											<div class="property-listing list_view h-100 m-0 shadow-0">
												...
												<div class="listing-img-wrapper">
													<div class="_exlio_125">For Sale</div>
													<div class="list-img-slide">
														<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'p-3.png' ) ); ?>" class="img-fluid mx-auto" alt="" /></a>
													</div>
												</div>
														...
														<div class="listing-short-detail-wrap">
															<div class="_card_list_flex mb-2">
																<div class="_card_flex_01">
																	...
																	<span class="_list_blickes types">Office</span>
																</div>
																<div class="_card_flex_last">
												...
												<div class="list_view_flex">
													...
													<div class="price-features-wrapper">
														<div class="list-fx-features">
															...
															<div class="listing-card-info-icon">
																<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="13" alt="" /></div>950 sqft
															</div>
														</div>
													</div>
										...
										<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
											<div class="property-listing list_view h-100 m-0 shadow-0">
												...
												<div class="listing-img-wrapper">
													<div class="_exlio_125">For Sale</div>
													<div class="list-img-slide">
														<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'p-8.png' ) ); ?>" class="img-fluid mx-auto" alt="" /></a>
													</div>
												</div>
												...
												<div class="list_view_flex">
													...
													<div class="price-features-wrapper">
														<div class="list-fx-features">
															...
															<div class="listing-card-info-icon">
																<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="13" alt="" /></div>850 sqft
															</div>
														</div>
													</div>
												...
												<div class="list_view_flex">
													...
													<div class="listing-detail-wrapper mt-1">
														<div class="listing-short-detail-wrap">
															...
															<div class="_card_list_flex">
																<div class="_card_flex_01">
																	<h4 class="listing-name verified"><a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-link-detail">425 Vine 012 Street, Montreal Canada, UHW45Q</a></h4>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="listing-short-detail-wrap">
															<div class="_card_list_flex mb-2">
																<div class="_card_flex_01">
																	...
																	<span class="_list_blickes types">Building</span>
																</div>
																<div class="_card_flex_last">
															...
															<div class="_card_list_flex">
																<div class="_card_flex_01">
																	<h4 class="listing-name verified"><a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>" class="prt-link-detail">1244 Vansh Market, Mise Mizkel Australia, AU456HA</a></h4>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
											<div class="property-listing list_view h-100 m-0 shadow-0">
												...
												<div class="listing-img-wrapper">
													<div class="_exlio_125">For Rent</div>
													<div class="list-img-slide">
														<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'p-13.png' ) ); ?>" class="img-fluid mx-auto" alt="" /></a>
													</div>
												</div>
										...
										<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
											<div class="property-listing list_view h-100 m-0 shadow-0">
												...
												<div class="listing-img-wrapper">
													<div class="_exlio_125">For Rent</div>
													<div class="list-img-slide">
														<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'p-15.png' ) ); ?>" class="img-fluid mx-auto" alt="" /></a>
													</div>
												</div>
										...
										<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
											<div class="property-listing list_view h-100 m-0 shadow-0">
												...
												<div class="listing-img-wrapper">
													<div class="_exlio_125">For Rent</div>
													<div class="list-img-slide">
														<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'p-16.png' ) ); ?>" class="img-fluid mx-auto" alt="" /></a>
													</div>
												</div>
										...
										<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
											<div class="property-listing list_view h-100 m-0 shadow-0">
												...
												<div class="listing-img-wrapper">
													<div class="_exlio_125">For Rent</div>
													<div class="list-img-slide">
														<a href="<?php echo esc_url( home_url( '/single-property-1/' ) ); ?>"><img src="<?php echo esc_url( murailles_img( 'p-9.png' ) ); ?>" class="img-fluid mx-auto" alt="" /></a>
													</div>
												</div>
												...
												<div class="list_view_flex">
													...
													<div class="listing-detail-wrapper mt-1">
														<div class="listing-short-detail-wrap">
															<div class="_card_list_flex mb-2">
																<div class="_card_flex_01">
																	<span class="_list_blickes _netork">12 Network</span>
																	<span class="_list_blickes types">Condos</span>
																</div>
																<div class="_card_flex_last">
												...
												<div class="list_view_flex">
													...
													<div class="price-features-wrapper">
														<div class="list-fx-features">
															...
															<div class="listing-card-info-icon">
																<div class="inc-fleat-icon"><img src="<?php echo esc_url( murailles_img( 'move.svg' ) ); ?>" width="13" alt="" /></div>960 sqft
															</div>
														</div>
													</div>
				...
				<div class="container">
					...
					<div class="row justify-content-center g-4">
						<div class="col-lg-4 col-md-4 col-sm-6">
							<a href="<?php echo esc_url( home_url( '/grid-layout-with-sidebar/' ) ); ?>" class="img-wrap">
