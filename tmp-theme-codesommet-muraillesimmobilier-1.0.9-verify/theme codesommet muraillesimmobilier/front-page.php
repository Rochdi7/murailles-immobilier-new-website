...
$murailles_front_about_text_3      = murailles_page_section_meta( 'about_text_3', murailles_t( "Chaque type de bien et chaque secteur de Marrakech répondent à une logique de marché distincte, c'est l'ensemble de ces savoir-faire que nous mettons à votre disposition. Chez Murailles Immobilier, nous vous aidons à trouver votre prochain bien à Marrakech et partout au Maroc : riad, villa, appartement, terrain ou local commercial.", false ), $murailles_front_page_id );
...
$murailles_front_home_testimonials_default = isset( $murailles_front_repeat_defaults['_murailles_home_testimonials'] ) ? $murailles_front_repeat_defaults['_murailles_home_testimonials'] : array();
$murailles_front_home_testimonials = function_exists( 'murailles_get_testimonials_meta_for_page' )
	? murailles_get_testimonials_meta_for_page( '_murailles_home_testimonials', $murailles_front_home_testimonials_default, $murailles_front_page_id )
	: murailles_get_repeatable_meta( '_murailles_home_testimonials', $murailles_front_home_testimonials_default, $murailles_front_page_id );
						...
						<div class="single_items" data-murailles-id="<?php echo esc_attr( $pid ); ?>">
							<div class="property-listing property-2 h-100">
								...
								<div class="listing-img-wrapper">
									...
									<div class="_adm_hot_badge"><i class="fa-solid fa-fire" aria-hidden="true"></i> <?php murailles_t( 'Hot' ); ?></div>
		<div class="list-img-slide">
									...
									<div class="listing-short-detail-wrap">
										<div class="_card_list_flex mb-2">
											...
											<div class="_card_flex_last">
												<div class="listing-card-info-price mb-0"><?php echo murailles_price_html( $pid ); ?><?php if ( $psuffix ) echo ' ' . esc_html( $psuffix ); ?></div>
											</div>
											<?php endif; ?>
										</div>
				...
				<div class="container">
					...
					<div class="collapse mt-5" id="qui-sommes-nous-details">
						<div class="row g-4">
							...
							<?php foreach ( $murailles_front_service_cards as $murailles_service_card ) : ?>
							...
							<div class="col-lg-12 mt-4">
								<div style="padding:24px 32px;background:#1a2332;color:#fff;border-radius:10px;text-align:center;">
									<p style="margin:0 0 6px;font-size:14px;letter-spacing:1px;text-transform:uppercase;color:#dc3545;font-weight:700;"><?php echo esc_html( isset( $murailles_front_commitment['title'] ) ? $murailles_front_commitment['title'] : murailles_t( 'Notre engagement', false ) ); ?></p>
			...
			<section>
				<div class="container">
					...
					<div class="row justify-content-center g-4">
						<?php foreach ( $murailles_front_city_tiles as $murailles_city_index => $murailles_city_tile ) : ?>
							<?php
							$murailles_city_link  = ! empty( $murailles_city_tile['link_url'] ) ? $murailles_city_tile['link_url'] : murailles_bien_url();
							$murailles_city_title = isset( $murailles_city_tile['title'] ) ? $murailles_city_tile['title'] : '';
							$murailles_city_label = isset( $murailles_city_tile['button_label'] ) ? $murailles_city_tile['button_label'] : '';
							$murailles_city_bg    = murailles_get_repeatable_image_url( $murailles_city_tile, murailles_img( 'city-3.png' ) );
							$murailles_city_class = isset( $murailles_front_city_classes[ $murailles_city_index ] ) ? $murailles_front_city_classes[ $murailles_city_index ] : 'col-lg-4 col-md-4 col-sm-6';
							?>
							<div class="<?php echo esc_attr( $murailles_city_class ); ?>">
								<a href="<?php echo esc_url( $murailles_city_link ); ?>" class="img-wrap">
									<div class="location_wrap_content visible">
										<div class="location_wrap_content_first">
											<h4><?php echo esc_html( $murailles_city_title ); ?></h4>
											<span><?php echo esc_html( $murailles_city_label ); ?></span>
										</div>
										<div class="location_btn"><i class="fa fa-arrow-right"></i></div>
									</div>
									<div class="img-wrap-background" style="background-image: url(<?php echo esc_url( $murailles_city_bg ); ?>);"></div>
								</a>
							</div>
						<?php endforeach; ?>
						<?php if ( false ) : ?>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="item-slide space">
								<?php foreach ( $murailles_front_home_testimonials as $murailles_testimonial ) : ?>
									<?php
